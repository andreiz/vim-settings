...
map <S-F2> :python debugger_property()<cr>
map <S-F3> :python debugger_watch_input("context_get")<cr>A<cr>
map <S-F4> :python debugger_watch_input("property_get", '<cword>')<cr>A<cr>
